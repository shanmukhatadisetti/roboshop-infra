parameters = [
  ...
  { name= "dev.user.payment_url", value = "mongodb://mongodb-dev.autonagar.in:27017/users", type= "String" },
  ...
  { name= "dev.catalogue.mongo_url", value = "mongodb://mongodb-dev.autonagar.in:27017/users", type= "String" },
